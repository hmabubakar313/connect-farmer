...
function Wishlist() {
  ...
  <div class="max-w-screen-xl px-4 py-3 mx-auto text-black ml-32">
  <div class="flex items-center">
    <ul class="flex flex-row font-medium mt-0 space-x-8 rtl:space-x-reverse text-sm">
      <li>
        <a href="#" class="text-black hover:underline" aria-current="page">Home</a>
      </li>
      <li>
        <a href="#" class="text-black hover:underline">Shop</a>
      </li>
      <li>
        <a href="#" class="text-black hover:underline">Pages</a>
      </li>
      <li>
        <a href="#" class="text-black hover:underline">Blog</a>
      </li>
      <li>
        <a href="#" class="text-black hover:underline">About US</a>
      </li>
      <li>
        <a href="#" class="text-black hover:underline">Contact US</a>
      </li>
    </ul>
